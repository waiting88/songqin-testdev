...
- 我们使用的官方的Python 语言解释器是用 什么语言实现的？   A
  A Java
  B C++
  C C
  D .NET 和 C#
...
### 判断题
```Shell
- Python 是大小写 不敏感的，print  'ok'  可以执行 Print  'ok' 也可以执行   N

- Python代码第一行语句，必须在文本文件的第一行   N

- Python代码第一行语句，前面一定不能有空格    Y

- 下面的语句 不对齐， 执行的时候 Python 解释器不会报错   N
